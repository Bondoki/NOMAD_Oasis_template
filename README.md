![docker image](https://github.com/Bondoki/NOMAD_Oasis_template/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Bondoki/NOMAD_Oasis_template.git
    cd NOMAD_Oasis_template
    ```

    or

    ```sh
    curl-L -o NOMAD_Oasis_template.zip "https://github.com/Bondoki/NOMAD_Oasis_template/archive/main.zip"
    unzip NOMAD_Oasis_template.zip
    cd NOMAD_Oasis_template
    ```
...
your `docker-compose.yaml` with `ghcr.io/bondoki/nomad_oasis_template:main` for the services
...
```sh
docker pull ghcr.io/bondoki/nomad_oasis_template/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Bondoki/NOMAD_Oasis_template/manifests/main": unauthorized`
